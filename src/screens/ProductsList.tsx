            ...
            {filtered.map((p) => {
              ...
              return (
                <div key={p.id} className="bg-surface-container-lowest rounded-xl border border-outline-variant/20 overflow-hidden">
                  <div className="relative bg-surface-container" style={{ aspectRatio: "16/10" }}>
                    <img src={p.img} alt={p.name} className={`w-full h-full object-cover ${selling ? "" : "grayscale opacity-60"}`} />
                    {!selling && (
